...
public class Modbus_Values {
    ...
    public static final int modbus_id_for_slave         = 0;            // 10000
    public static final int enable_ttl_smartone         = 2;            // 10001
    public static final int mikrobus_1_device_type      = 0;            // 10002
    public static final int mikrobus_1_comm_proto       = 0;            // 10003
    public static final int mikrobus_1_floaterface      = 0;            // 10004
    public static final int mikrobus_1_rs232_baud       = 0;            // 10005
    public static final int mikrobus_1_rs232_parity     = 0;            // 10006
    public static final int mikrobus_1_rs232_data       = 8;            // 10007
    public static final int mikrobus_1_rs232_stop       = 1;            // 10008
    public static final int mikrobus_2_device_type      = 0;            // 10009
    public static final int mikrobus_2_comm_proto       = 1;            // 10010
    public static final int mikrobus_2_floaterface      = 0;            // 10011
    public static final int mikrobus_2_rs232_baud       = 0;            // 10012
    public static final int mikrobus_2_rs232_parity     = 0;            // 10013
    public static final int mikrobus_2_rs232_data       = 8;            // 10014
    public static final int mikrobus_2_rs232_stop       = 1;            // 10015
    public static final int rs485_floaterface_mode      = 1;            // 10016
    public static final int rs485_baud_rate             = 0;            // 10017
    public static final int rs485_parity_bit            = 0;            // 10018
    public static final int rs485_data_bits             = 8;            // 10019
    public static final int rs485_stop_bits             = 1;            // 10020
    public static final int auto_reports_per_day        = 2;            // 10021
    public static final int diag_reports_per_month      = 4;            // 10022
    public static final int power_mode                  = 0;            // 10025
    public static final int rtc_seconds                 = 0;            // 10026
    public static final int rtc_minutes                 = 0;            // 10027
    public static final int rtc_hours                   = 0;            // 10028
    public static final int rtc_day_of_month            = 1;            // 10029
    public static final int rtc_month                   = 1;            // 10030
    public static final int rtc_year                    = 2017;         // 10031
    public static final int rtc_day_light_savings       = 0;            // 10032
    public static final int rtc_time_zone               = 5;            // 10033
    public static final int enable_nfc_security         = 0;            // 10034
    public static final int enable_rs232_security       = 0;            // 10035
    public static final int phone_programming_revision  = 0;            // 10036
    /* ************** 035 ********* Modbus 10000 ********* 035 ************** */

    /* ************** 008 ********* Modbus 10100 ********* 008 ************** */
    public static final int li_1_mode                   = 1;            // 10100
    public static final int li_2_mode                   = 1;            // 10102
    public static final int li_3_mode                   = 1;            // 10104
    public static final int li_4_mode                   = 1;            // 10106
    public static final int li_5_mode                   = 1;            // 10108
    public static final int li_6_mode                   = 1;            // 10110
    public static final int li_7_mode                   = 1;            // 10112
    public static final int li_8_mode                   = 1;            // 10114
    /* ************** 008 ********* Modbus 10100 ********* 008 ************** */

    /* ************** 144 ********* Modbus 10200 ********* 144 ************** */
    public static final int mod_reg_1_enable_id         = 0;            // 10200
    public static final int mod_reg_1_command           = 2;            // 10201
    public static final int mod_reg_1_address           = 0;            // 10202
    public static final int mod_reg_1_data_format       = 1;            // 10203
    public static final int mod_reg_1_alarm_config      = 3;            // 10204
    public static final int mod_reg_1_output_options    = 0;            // 10205
    public static final int mod_reg_2_enable_id         = 0;            // 10206
    public static final int mod_reg_2_command           = 2;            // 10207
    public static final int mod_reg_2_address           = 0;            // 10208
    public static final int mod_reg_2_data_format       = 1;            // 10209
    public static final int mod_reg_2_alarm_config      = 3;            // 10210
    public static final int mod_reg_2_output_options    = 0;            // 10211
    public static final int mod_reg_3_enable_id         = 0;            // 10212
    public static final int mod_reg_3_command           = 2;            // 10213
    public static final int mod_reg_3_address           = 0;            // 10214
    public static final int mod_reg_3_data_format       = 1;            // 10215
    public static final int mod_reg_3_alarm_config      = 3;            // 10216
    public static final int mod_reg_3_output_options    = 0;            // 10217
    public static final int mod_reg_4_enable_id         = 0;            // 10218
    public static final int mod_reg_4_command           = 2;            // 10219
    public static final int mod_reg_4_address           = 0;            // 10220
    public static final int mod_reg_4_data_format       = 1;            // 10221
    public static final int mod_reg_4_alarm_config      = 3;            // 10222
    public static final int mod_reg_4_output_options    = 0;            // 10223
    public static final int mod_reg_5_enable_id         = 0;            // 10224
    public static final int mod_reg_5_command           = 2;            // 10225
    public static final int mod_reg_5_address           = 0;            // 10226
    public static final int mod_reg_5_data_format       = 1;            // 10227
    public static final int mod_reg_5_alarm_config      = 3;            // 10228
    public static final int mod_reg_5_output_options    = 0;            // 10229
    public static final int mod_reg_6_enable_id         = 0;            // 10230
    public static final int mod_reg_6_command           = 2;            // 10231
    public static final int mod_reg_6_address           = 0;            // 10232
    public static final int mod_reg_6_data_format       = 1;            // 10233
    public static final int mod_reg_6_alarm_config      = 3;            // 10234
    public static final int mod_reg_6_output_options    = 0;            // 10235
    public static final int mod_reg_7_enable_id         = 0;            // 10236
    public static final int mod_reg_7_command           = 2;            // 10237
    public static final int mod_reg_7_address           = 0;            // 10238
    public static final int mod_reg_7_data_format       = 1;            // 10239
    public static final int mod_reg_7_alarm_config      = 3;            // 10240
    public static final int mod_reg_7_output_options    = 0;            // 10241
    public static final int mod_reg_8_enable_id         = 0;            // 10242
    public static final int mod_reg_8_command           = 2;            // 10243
    public static final int mod_reg_8_address           = 0;            // 10244
    public static final int mod_reg_8_data_format       = 1;            // 10245
    public static final int mod_reg_8_alarm_config      = 3;            // 10246
    public static final int mod_reg_8_output_options    = 0;            // 10247
    public static final int mod_reg_9_enable_id         = 0;            // 10248
    public static final int mod_reg_9_command           = 2;            // 10249
    public static final int mod_reg_9_address           = 0;            // 10250
    public static final int mod_reg_9_data_format       = 1;            // 10251
    public static final int mod_reg_9_alarm_config      = 3;            // 10252
    public static final int mod_reg_9_output_options    = 0;            // 10253
    public static final int mod_reg_10_enable_id        = 0;            // 10254
    public static final int mod_reg_10_command          = 2;            // 10255
    public static final int mod_reg_10_address          = 0;            // 10256
    public static final int mod_reg_10_data_format      = 1;            // 10257
    public static final int mod_reg_10_alarm_config     = 3;            // 10258
    public static final int mod_reg_10_output_options   = 0;            // 10259
    public static final int mod_reg_11_enable_id        = 0;            // 10260
    public static final int mod_reg_11_command          = 2;            // 10261
    public static final int mod_reg_11_address          = 0;            // 10262
    public static final int mod_reg_11_data_format      = 1;            // 10263
    public static final int mod_reg_11_alarm_config     = 3;            // 10264
    public static final int mod_reg_11_output_options   = 0;            // 10265
    public static final int mod_reg_12_enable_id        = 0;            // 10266
    public static final int mod_reg_12_command          = 2;            // 10267
    public static final int mod_reg_12_address          = 0;            // 10268
    public static final int mod_reg_12_data_format      = 1;            // 10269
    public static final int mod_reg_12_alarm_config     = 3;            // 10270
    public static final int mod_reg_12_output_options   = 0;            // 10271
    public static final int mod_reg_13_enable_id        = 0;            // 10272
    public static final int mod_reg_13_command          = 2;            // 10273
    public static final int mod_reg_13_address          = 0;            // 10274
    public static final int mod_reg_13_data_format      = 1;            // 10275
    public static final int mod_reg_13_alarm_config     = 3;            // 10276
    public static final int mod_reg_13_output_options   = 0;            // 10277
    public static final int mod_reg_14_enable_id        = 0;            // 10278
    public static final int mod_reg_14_command          = 2;            // 10279
    public static final int mod_reg_14_address          = 0;            // 10280
    public static final int mod_reg_14_data_format      = 1;            // 10281
    public static final int mod_reg_14_alarm_config     = 3;            // 10282
    public static final int mod_reg_14_output_options   = 0;            // 10283
    public static final int mod_reg_15_enable_id        = 0;            // 10284
    public static final int mod_reg_15_command          = 2;            // 10285
    public static final int mod_reg_15_address          = 0;            // 10286
    public static final int mod_reg_15_data_format      = 1;            // 10287
    public static final int mod_reg_15_alarm_config     = 3;            // 10288
    public static final int mod_reg_15_output_options   = 0;            // 10289
    public static final int mod_reg_16_enable_id        = 0;            // 10290
    public static final int mod_reg_16_command          = 2;            // 10291
    public static final int mod_reg_16_address          = 0;            // 10292
    public static final int mod_reg_16_data_format      = 1;            // 10293
    public static final int mod_reg_16_alarm_config     = 3;            // 10294
    public static final int mod_reg_16_output_options   = 0;            // 10295
    public static final int mod_reg_17_enable_id        = 0;            // 10296
    public static final int mod_reg_17_command          = 2;            // 10297
    public static final int mod_reg_17_address          = 0;            // 10298
    public static final int mod_reg_17_data_format      = 1;            // 10299
    public static final int mod_reg_17_alarm_config     = 3;            // 10300
    public static final int mod_reg_17_output_options   = 0;            // 10301
    public static final int mod_reg_18_enable_id        = 0;            // 10302
    public static final int mod_reg_18_command          = 2;            // 10303
    public static final int mod_reg_18_address          = 0;            // 10304
    public static final int mod_reg_18_data_format      = 1;            // 10305
    public static final int mod_reg_18_alarm_config     = 3;            // 10306
    public static final int mod_reg_18_output_options   = 0;            // 10307
    public static final int mod_reg_19_enable_id        = 0;            // 10308
    public static final int mod_reg_19_command          = 2;            // 10309
    public static final int mod_reg_19_address          = 0;            // 10310
    public static final int mod_reg_19_data_format      = 1;            // 10311
    public static final int mod_reg_19_alarm_config     = 3;            // 10312
    public static final int mod_reg_19_output_options   = 0;            // 10313
    public static final int mod_reg_20_enable_id        = 0;            // 10314
    public static final int mod_reg_20_command          = 2;            // 10315
    public static final int mod_reg_20_address          = 0;            // 10316
    public static final int mod_reg_20_data_format      = 1;            // 10317
    public static final int mod_reg_20_alarm_config     = 3;            // 10318
    public static final int mod_reg_20_output_options   = 0;            // 10319
    public static final int mod_reg_21_enable_id        = 0;            // 10320
    public static final int mod_reg_21_command          = 2;            // 10321
    public static final int mod_reg_21_address          = 0;            // 10322
    public static final int mod_reg_21_data_format      = 1;            // 10323
    public static final int mod_reg_21_alarm_config     = 3;            // 10324
    public static final int mod_reg_21_output_options   = 0;            // 10325
    public static final int mod_reg_22_enable_id        = 0;            // 10326
    public static final int mod_reg_22_command          = 2;            // 10327
    public static final int mod_reg_22_address          = 0;            // 10328
    public static final int mod_reg_22_data_format      = 1;            // 10329
    public static final int mod_reg_22_alarm_config     = 3;            // 10330
    public static final int mod_reg_22_output_options   = 0;            // 10331
    public static final int mod_reg_23_enable_id        = 0;            // 10332
    public static final int mod_reg_23_command          = 2;            // 10333
    public static final int mod_reg_23_address          = 0;            // 10334
    public static final int mod_reg_23_data_format      = 1;            // 10335
    public static final int mod_reg_23_alarm_config     = 3;            // 10336
    public static final int mod_reg_23_output_options   = 0;            // 10337
    public static final int mod_reg_24_enable_id        = 0;            // 10338
    public static final int mod_reg_24_command          = 2;            // 10339
    public static final int mod_reg_24_address          = 0;            // 10340
    public static final int mod_reg_24_data_format      = 1;            // 10341
    public static final int mod_reg_24_alarm_config     = 3;            // 10342
    public static final int mod_reg_24_output_options   = 0;            // 10343
    /* ************** 144 ********* Modbus 10200 ********* 144 ************** */

    /* ************** 008 ********* Modbus 12000 ********* 008 ************** */
    public static final int li_1_recog_time             = 3;            // 12000
    public static final int li_2_recog_time             = 3;            // 12001
    public static final int li_3_recog_time             = 3;            // 12002
    public static final int li_4_recog_time             = 3;            // 12003
    public static final int li_5_recog_time             = 3;            // 12004
    public static final int li_6_recog_time             = 3;            // 12005
    public static final int li_7_recog_time             = 3;            // 12006
    public static final int li_8_recog_time             = 3;            // 12007
    /* ************** 008 ********* Modbus 12000 ********* 008 ************** */

    /* ************** 154 ********* Modbus 12100 ********* 154 ************** */
    public static final int sm_no_reply_count           = 0;            // 12100
    public static final int sm_bad_reply_count          = 0;            // 12101
    public static final int mikrobus_1_no_reply_count   = 0;            // 12102
    public static final int mikrobus_1_bad_reply_count  = 0;            // 12103
    public static final int mikrobus_2_no_reply_count   = 0;            // 12104
    public static final int mikrobus_2_bad_reply_count  = 0;            // 12105
    public static final int mod_reg_1_no_reply_count    = 0;            // 12106
    public static final int mod_reg_1_bad_reply_count   = 0;            // 12107
    public static final int mod_reg_2_no_reply_count    = 0;            // 12108
    public static final int mod_reg_2_bad_reply_count   = 0;            // 12109
    public static final int mod_reg_3_no_reply_count    = 0;            // 12110
    public static final int mod_reg_3_bad_reply_count   = 0;            // 12111
    public static final int mod_reg_4_no_reply_count    = 0;            // 12112
    public static final int mod_reg_4_bad_reply_count   = 0;            // 12113
    public static final int mod_reg_5_no_reply_count    = 0;            // 12114
    public static final int mod_reg_5_bad_reply_count   = 0;            // 12115
    public static final int mod_reg_6_no_reply_count    = 0;            // 12116
    public static final int mod_reg_6_bad_reply_count   = 0;            // 12117
    public static final int mod_reg_7_no_reply_count    = 0;            // 12118
    public static final int mod_reg_7_bad_reply_count   = 0;            // 12119
    public static final int mod_reg_8_no_reply_count    = 0;            // 12120
    public static final int mod_reg_8_bad_reply_count   = 0;            // 12121
    public static final int mod_reg_9_no_reply_count    = 0;            // 12122
    public static final int mod_reg_9_bad_reply_count   = 0;            // 12123
    public static final int mod_reg_10_no_reply_count   = 0;            // 12124
    public static final int mod_reg_10_bad_reply_count  = 0;            // 12125
    public static final int mod_reg_11_no_reply_count   = 0;            // 12126
    public static final int mod_reg_11_bad_reply_count  = 0;            // 12127
    public static final int mod_reg_12_no_reply_count   = 0;            // 12128
    public static final int mod_reg_12_bad_reply_count  = 0;            // 12129
    public static final int mod_reg_13_no_reply_count   = 0;            // 12130
    public static final int mod_reg_13_bad_reply_count  = 0;            // 12131
    public static final int mod_reg_14_no_reply_count   = 0;            // 12132
    public static final int mod_reg_14_bad_reply_count  = 0;            // 12133
    public static final int mod_reg_15_no_reply_count   = 0;            // 12134
    public static final int mod_reg_15_bad_reply_count  = 0;            // 12135
    public static final int mod_reg_16_no_reply_count   = 0;            // 12136
    public static final int mod_reg_16_bad_reply_count  = 0;            // 12137
    public static final int mod_reg_17_no_reply_count   = 0;            // 12138
    public static final int mod_reg_17_bad_reply_count  = 0;            // 12139
    public static final int mod_reg_18_no_reply_count   = 0;            // 12140
    public static final int mod_reg_18_bad_reply_count  = 0;            // 12141
    public static final int mod_reg_19_no_reply_count   = 0;            // 12142
    public static final int mod_reg_19_bad_reply_count  = 0;            // 12143
    public static final int mod_reg_20_no_reply_count   = 0;            // 12144
    public static final int mod_reg_20_bad_reply_count  = 0;            // 12145
    public static final int mod_reg_21_no_reply_count   = 0;            // 12146
    public static final int mod_reg_21_bad_reply_count  = 0;            // 12147
    public static final int mod_reg_22_no_reply_count   = 0;            // 12148
    public static final int mod_reg_22_bad_reply_count  = 0;            // 12149
    public static final int mod_reg_23_no_reply_count   = 0;            // 12150
    public static final int mod_reg_23_bad_reply_count  = 0;            // 12151
    public static final int mod_reg_24_no_reply_count   = 0;            // 12152
    public static final int mod_reg_24_bad_reply_count  = 0;            // 12153
    /* ************** 154 ********* Modbus 12100 ********* 154 ************** */

    /* ************** 032 ********* Modbus 13000 ********* 032 ************** */
    public static final long li_1_pulse_today           = 0;            // 13000
    public static final long li_1_pulse_yesterday       = 0;            // 13001
    public static final long li_1_pulse_this_month      = 0;            // 13002
    public static final long li_1_pulse_last_month      = 0;            // 13003
    public static final long li_2_pulse_today           = 0;            // 13004
    public static final long li_2_pulse_yesterday       = 0;            // 13005
    public static final long li_2_pulse_this_month      = 0;            // 13006
    public static final long li_2_pulse_last_month      = 0;            // 13007
    public static final long li_3_pulse_today           = 0;            // 13008
    public static final long li_3_pulse_yesterday       = 0;            // 13009
    public static final long li_3_pulse_this_month      = 0;            // 13010
    public static final long li_3_pulse_last_month      = 0;            // 13011
    public static final long li_4_pulse_today           = 0;            // 13012
    public static final long li_4_pulse_yesterday       = 0;            // 13013
    public static final long li_4_pulse_this_month      = 0;            // 13014
    public static final long li_4_pulse_last_month      = 0;            // 13015
    public static final long li_5_pulse_today           = 0;            // 13016
    public static final long li_5_pulse_yesterday       = 0;            // 13017
    public static final long li_5_pulse_this_month      = 0;            // 13018
    public static final long li_5_pulse_last_month      = 0;            // 13019
    public static final long li_6_pulse_today           = 0;            // 13020
    public static final long li_6_pulse_yesterday       = 0;            // 13021
    public static final long li_6_pulse_this_month      = 0;            // 13022
    public static final long li_6_pulse_last_month      = 0;            // 13023
    public static final long li_7_pulse_today           = 0;            // 13024
    public static final long li_7_pulse_yesterday       = 0;            // 13025
    public static final long li_7_pulse_this_month      = 0;            // 13026
    public static final long li_7_pulse_last_month      = 0;            // 13027
    public static final long li_8_pulse_today           = 0;            // 13028
    public static final long li_8_pulse_yesterday       = 0;            // 13029
    public static final long li_8_pulse_this_month      = 0;            // 13030
    public static final long li_8_pulse_last_month      = 0;            // 13031
    /* ************** 032 ********* Modbus 13000 ********* 032 ************** */
    ...
    public static final int Size_1 = 249;
    public static final int Size_2 = 32;
    public static final int Size_3 = 80;
    public static final int Size_4 = 64;

    public static int[] Modbus_1 =         {modbus_id_for_slave,        enable_ttl_smartone,        mikrobus_1_device_type,     mikrobus_1_comm_proto,
    ...
    public static long[] Modbus_2 =        {li_1_pulse_today,           li_1_pulse_yesterday,       li_1_pulse_this_month,      li_1_pulse_last_month,
